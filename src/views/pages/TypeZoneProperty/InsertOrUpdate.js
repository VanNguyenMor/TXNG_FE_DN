      ...
      <div className="wrap-insert-or-update-type-zone-property">
        ...
        {id ? (
          <div>
            {dataProduct ? (
              <div
                className="wrap-insert-or-update-type-zone-property-item "
        ...
        <div
          className="wrap-insert-or-update-type-zone-property-table"
          style={{ marginTop: 5 }}
        >
          ...
          <table className="wrap-insert-or-update-type-zone-property-list">
            <thead className="wrap-insert-or-update-type-zone-property-list-header">
              <tr className="wrap-insert-or-update-type-zone-property-list-header-row">
                <th className="wrap-insert-or-update-type-zone-property-list-header-row-col-1">
                  STT
                </th>
                <th className="wrap-insert-or-update-type-zone-property-list-header-row-col">
                  TÊN THUỘC TÍNH
                </th>
                <th className="wrap-insert-or-update-type-zone-property-list-header-row-col">
                  KIỂU DỮ LIỆU
            ...
            <tbody className="wrap-insert-or-update-type-zone-property-list-body">
              {(zones || []).map((item, index) => {
                return (
                  <tr
                    key={item.id}
                    className="wrap-insert-or-update-type-zone-property-list-body-row"
                  >
                    <td className="wrap-insert-or-update-type-zone-property-list-body-row-col-1">
                      {index + 1}
                    </td>
                    <td className="wrap-insert-or-update-type-zone-property-list-body-row-col">
                      <input
                        onChange={this.onChangeNameProperty(item.id)}
                    ...
                    <td className="wrap-insert-or-update-type-zone-property-list-body-row-col">
                      <select
                        onChange={this.onChangeTypeProperty(item.id)}
                        value={item.dataType}
                        className="wrap-insert-or-update-type-zone-property-list-body-row-col-select"
                      >
                        <option selected={item.dataType == 1} value="1">
                          Text
                        </option>
                        <option selected={item.dataType == 2} value="2">
                          Number
                        </option>
                    ...
                    <td className="wrap-insert-or-update-type-zone-property-list-body-row-col">
                      <input
                        onChange={this.onChangeValueProperty(item.id)}
                        placeholder="Giá trị"
                        type="text"
                        value={item.value}
                        className="wrap-insert-or-update-type-zone-property-list-body-row-col-input"
                    ...
                    <td className="wrap-insert-or-update-type-zone-property-list-body-row-col wrap-insert-or-update-type-zone-property-list-body-row-col-4">
                      ...
                      >
                        <img
                          className="wrap-insert-or-update-type-zone-property-list-body-row-col-delete-icon"
                          src={IconDelete}
                        />
                      </button>
                    </td>
        ...
        <div className="wrap-insert-or-update-type-zone-property-add">
          <button
            ...
            className="wrap-insert-or-update-type-zone-property-add-button"
            style={{ width: 25, height: 25 }}
          >
            <img
              className="wrap-insert-or-update-type-zone-property-add-button-icon"
