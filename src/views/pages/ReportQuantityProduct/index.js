...
import { REPORT_QUANTITY_PRODUCT } from "../../../helpers/constant";
...
class ReportQuantityProduct extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: null,
            district: null,
            ward: null,
            headerTitle: REPORT_QUANTITY_PRODUCT,
            districtId: '',
            wardId: '',
            productName: '',
            productGroupId: '',
            ...
            toDate: '',
            page: 0,
            limit: LIMITS.reportV2ListQuantityProduct,
            productGroups: []
        }
    ...
    onFilter = () => {
        const { fromDate, toDate, productName, productGroupId, districtId, wardId, page, limit } = this.state;
        const { getReportListQuantityProduct } = this.props;
        ...
        getReportListQuantityProduct(body).then(res => {
    ...
    onExcel = () => {
        const { fromDate, toDate, productName, productGroupId, districtId, wardId, page, limit } = this.state;
        const { printExcelReportListQuantityProduct } = this.props;
        ...
        printExcelReportListQuantityProduct(body).then(res => {
            ...
            if (ok) {
                ...
                if (data) {
                    fakeDownloadLinkFile(data, FILE_NAMES.reportV2ListQuantityProduct());
            ...
            <>
                {
                    <div className={classes.wrapper}>
                        <Container fluid>
                            ...
                            <h3 className={`${classes.text} ${classes.textLable}`}> BÁO CÁO SẢN LƯỢNG HÀNG HÓA CHI TIẾT</h3>
