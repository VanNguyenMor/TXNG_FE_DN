                                                ...
                                                fileUpdate.map((item, key) => {
                                                    ...
                                                    return <tr key={key} style={{ ...generateStyleTableCol(this.tableBody, (fileUpdate || []).length), height: 'auto' }}>
                                                        ...
                                                        <td style={{ textAlign: 'center' }} className='table-scale-col'>
                                                            <span>{item.uploadDate ? moment(item.uploadDate).format('HH:mm') : moment(item.expiredDate).format('HH:mm')}</span><br />
                                                            <span>{item.uploadDate ? moment(item.uploadDate).format('DD/MM/YYYY') : moment(item.expiredDate).format('DD/MM/YYYY')}</span>
                                                        </td>
