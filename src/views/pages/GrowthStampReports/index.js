...
class GrowthStampReports extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: null,
                                            ...
                                            <div className="row" style={{ flexWrap: 'inherit', }}>
                                                ...
                                                <div style={{ marginTop: -4 }}>
                                                    <Input
                                                        ...
                                                        onBlur={(event) => this.handleChangeQuarter(event)}
                                                        onKeyUp={(event) => {
                                                            if (event.which == 13) {
                                            ...
                                            <div className="row" style={{ flexWrap: 'inherit', width: 280 }}>
                                                ...
                                                <div style={{ width: 90, marginRight: 10, marginTop: -4 }}>
                                                    <Input
                                                        ...
                                                        onBlur={(event) => this.handleChangeYear(event)}
                                                        onKeyUp={(event) => {
                                                            if (event.which == 13) {
                            ...
                            {isChecked == 2 ? (
                                <Bar
                                    ...
                                    options={{
                                        ...
                                        title: {
                                            display: true,
                                            text: 'BIỂU ĐỒ TĂNG TRƯỞNG TEM NĂM ' + yearQ,
                                            fontSize: 20,
                                            fontColor: 'blue'
                                        },
                                        legend: {
                            ...
                            {isChecked == 3 ? (
                                <Bar
                                    ...
                                    options={{
                                        ...
                                        title: {
                                            display: true,
                                            text: 'BIỂU ĐỒ TĂNG TRƯỞNG TEM TỪ ' + dataYear.yearfromY + ' ' + 'ĐẾN ' + dataYear.yeartoY,
                                            fontSize: 20,
                                            fontColor: 'blue'
                                        },
                                        legend: {
