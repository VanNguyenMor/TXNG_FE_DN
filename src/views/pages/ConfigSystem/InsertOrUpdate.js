...
class InsertOrUpdate extends Component {
    ...
    render() {
        const { errors, dataCompany, id, options } = this.props;
                            ...
                            <div className='config-system-insert-or-update-form-box-item'>
                                ...
                                <div className='config-system-insert-or-update-form-box-item-box'>
                                    ...
                                    <SelectSearch
                                        options={options}
                                        value={companyID}
                                        onChange={this.onChangeSelect('companyID')}
                                        search
                            ...
                            <div className='config-system-insert-or-update-form-box-item'>
                                ...
                                <div className='config-system-insert-or-update-form-box-item-box'>
                                    {/* <input
                                        ...
                                        type='checkbox'
                                        checked={isUsed}
                                        className='config-system-insert-or-update-form-box-item-checkbox-input'
