...
export const PRICES_HEADER = ["Stt", "Số năm", "Số tiền"];
...
export const FILE_UPLOAD = ["Stt", "Thời gian", "File"];
...
export const COMPANY_NOT_COMFIRM_HEADER_SEARCH =
  "Tìm kiếm danh sách không duyệt";
...
export const FIELD_LIST_HEADER = ["Stt", "Mã ngành", "Ngành nghề"];
...
export const TABLE_REPORT = ["Stt", "Cột 1", "Cột 2"];
...
export const STAMPTEMPLATE = ["Stt", "Mẫu", "Tên"];

export const ALERT = ["Stt", "Nhóm quyền", "Thông báo"];
...
export const UNIT = ["Stt", "Đơn vị tính"];
...
export const MENU_LIST_HEADER = ["Stt", "Tên menu"];
...
export const PLANTINGTYPE_LIST_HEADER = ["Stt", "Thể loại"];
...
export const LIABILITIES_STAPM_HEADER = ["Stt", "Số tiền", "Tên doanh nghiệp"];
...
export const FILE_NAMES = {
  reportV2ListCompany: () =>
    `danh_sach_cong_ty_trong_tinh_${getCurrentDatetimeStringForFile()}.xls`,
  reportV2ListProduct: () =>
    `danh_sach_mat_hang_trong_tinh_${getCurrentDatetimeStringForFile()}.xls`,
  reportV2ListQuantityProductByPlantingZone: () =>
    `san_luong_hang_hoa_theo_vung_${getCurrentDatetimeStringForFile()}.xls`,
  reportV2ListQuantityProduct: () =>
    `san_luong_hang_hoa_chi_tiet_${getCurrentDatetimeStringForFile()}.xls`,
  reportV2ListZoningPlantingZone: () =>
    `bao_cao_quy_hoach_vung_san_xuat_${getCurrentDatetimeStringForFile()}.xls`,
  reportV2ListZoningPlantingZoneByCompany: () =>
    `bao_cao_quy_hoach_vung_san_xuat_theo_doanh_nghiep_${getCurrentDatetimeStringForFile()}.xls`,
};

export const PRODUCT_TYPE_DATES = [
  {
    value: 0,
    label: "Tháng",
  },
...
export const PRODUCT_EXPIRED_TYPE = [
    {
        value: 0,
        label: 'Từ ngày mở bao bì',
    },
    {
        value: 1,
        label: 'Từ ngày sản xuất',
    },
];