...
// export const CLIENT_ID = 'AdminClientId';
// export const CLIENT_SECRET = '4884db16-0d52-a069-457d-727db99ab673';
export const DOMAIN = 'http://localhost:8088/';//'https://truyxuatnguongoc.tiengiang.gov.vn:9803/';// dm ca1i api chinh1 ne2
//export const DOMAIN = 'https://localhost:44310/';// dm Test
export const BASE_URL = 'https://hcm-ids-v1.tracecenter.vn/';//'https://truyxuatnguongoc.tiengiang.gov.vn:9903/';
...
export const GET_LOCK_STAMP_LIST_TYPE = 'GET_LOCK_STAMP_LIST_TYPE';
export const GET_LOCK_STAMP_LIST_SUCCESS_TYPE = 'GET_LOCK_STAMP_LIST_SUCCESS_TYPE';
export const GET_LOCK_STAMP_LIST_FAIL_TYPE = 'GET_LOCK_STAMP_LIST_FAIL_TYPE';
...
export const TRACE_GET_FIELDS_TYPE = 'TRACE_GET_FIELDS_TYPE';
export const TRACE_GET_FIELDS_SUCCESS_TYPE = 'TRACE_GET_FIELDS_SUCCESS_TYPE';
export const TRACE_GET_FIELDS_FAIL_TYPE = 'TRACE_GET_FIELDS_FAIL_TYPE';

export const TRACE_GET_PRODUCT_BY_TRACE_TYPE = 'TRACE_GET_PRODUCT_BY_TRACE_TYPE';
export const TRACE_GET_PRODUCT_BY_TRACE_SUCCESS_TYPE = 'TRACE_GET_PRODUCT_BY_TRACE_SUCCESS_TYPE';
export const TRACE_GET_PRODUCT_BY_TRACE_FAIL_TYPE = 'TRACE_GET_PRODUCT_BY_TRACE_FAIL_TYPE';

export const TRACE_DELETE_TYPE = 'TRACE_DELETE_TYPE';
export const TRACE_DELETE_SUCCESS_TYPE = 'TRACE_DELETE_SUCCESS_TYPE';
export const TRACE_DELETE_FAIL_TYPE = 'TRACE_DELETE_FAIL_TYPE';

export const TRACE_COMPLETED_TYPE = 'TRACE_COMPLETED_TYPE';
export const TRACE_COMPLETED_SUCCESS_TYPE = 'TRACE_COMPLETED_SUCCESS_TYPE';
export const TRACE_COMPLETED_FAIL_TYPE = 'TRACE_COMPLETED_FAIL_TYPE';

export const TRACE_CREATE_TYPE = 'TRACE_CREATE_TYPE';
export const TRACE_CREATE_SUCCESS_TYPE = 'TRACE_CREATE_SUCCESS_TYPE';
export const TRACE_CREATE_FAIL_TYPE = 'TRACE_CREATE_FAIL_TYPE';

export const TRACE_GET_FIELD_FOR_ADD_TYPE = 'TRACE_GET_FIELD_FOR_ADD_TYPE';
export const TRACE_GET_FIELD_FOR_ADD_SUCCESS_TYPE = 'TRACE_GET_FIELD_FOR_ADD_SUCCESS_TYPE';
export const TRACE_GET_FIELD_FOR_ADD_FAIL_TYPE = 'TRACE_GET_FIELD_FOR_ADD_FAIL_TYPE';
...
//TRANSPORTATION
export const TRANSPORTATION_LIST_TYPE = 'TRANSPORTATION_LIST_TYPE';
export const TRANSPORTATION_LIST_SUCCESS_TYPE = 'TRANSPORTATION_LIST_SUCCESS_TYPE';
export const TRANSPORTATION_LIST_FAIL_TYPE = 'TRANSPORTATION_LIST_FAIL_TYPE';
export const TRANSPORTATION_CREATE_TYPE = 'TRANSPORTATION_CREATE_TYPE';
export const TRANSPORTATION_CREATE_SUCCESS_TYPE = 'TRANSPORTATION_CREATE_SUCCESS_TYPE';
export const TRANSPORTATION_CREATE_FAIL_TYPE = 'TRANSPORTATION_CREATE_FAIL_TYPE';
export const TRANSPORTATION_GET_TYPE = 'TRANSPORTATION_GET_TYPE';
export const TRANSPORTATION_GET_SUCCESS_TYPE = 'TRANSPORTATION_GET_SUCCESS_TYPE';
export const TRANSPORTATION_GET_FAIL_TYPE = 'TRANSPORTATION_GET_FAIL_TYPE';
export const TRANSPORTATION_UPDATE_TYPE = 'TRANSPORTATION_UPDATE_TYPE';
export const TRANSPORTATION_UPDATE_SUCCESS_TYPE = 'TRANSPORTATION_UPDATE_SUCCESS_TYPE';
export const TRANSPORTATION_UPDATE_FAIL_TYPE = 'TRANSPORTATION_UPDATE_FAIL_TYPE';
export const TRANSPORTATION_DELETE_TYPE = 'TRANSPORTATION_DELETE_TYPE';
export const TRANSPORTATION_DELETE_SUCCESS_TYPE = 'TRANSPORTATION_DELETE_SUCCESS_TYPE';
export const TRANSPORTATION_DELETE_FAIL_TYPE = 'TRANSPORTATION_DELETE_FAIL_TYPE';
