...
class WarningPopupPlus extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { warningPopupModalPlus, toggleModal, moduleTitle, moduleBody, handleWarning } = this.props;

    return (
      <>
        <Modal
          className="modal-dialog-centered"
          isOpen={warningPopupModalPlus}
          autoFocus={false}
        >
          ...
          <div className={`modal-footer ${classes.modalButtonArea}`}>
            <Button 
              ...
              type="button"
              onClick={() => {
                toggleModal('warningPopupModalPlus');
                handleWarning();
              }}
            >
            ...
            <Button
              ...
              data-dismiss="modal"
              type="button"
              onClick={() => toggleModal('warningPopupModalPlus')}
            >
...
export default WarningPopupPlus;
