...
class UpdatePopup3 extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		const { updateModal3, toggleModal, moduleTitle, moduleBody, activeSubmit, handleUpdateInfoData, newData, componentFooter } = this.props;
				...
				>
					...
					<div className={`modal-footer ${classes.modalButtonArea}`}>
						...
						<Button
							...
							onClick={() => {
								this.toggleModalA('updateModal3');
						...
						<Button
							...
							onClick={() => toggleModal('updateModal3')}
						>
